        ...
        <div className='flex flex-row justify-center items-stretch'>
          <div className='shadow-lg rounded-lg m-5 bg-slate-300'>
            ...
            <div className='px-10 py-5 '>
              <h3>DÉVELOPPEUR WEB et INFORGRAPHISTE</h3>
              ...
              <h3>DÉVELOPPEUR WEB, INFOGRAPHISTE</h3>
              <p>2015 - 2010<br/> 
              Micrologik, Menton</p>
          ...
          <div className='shadow-lg rounded-lg m-5 bg-slate-300'>
            ...
            <div className='px-10 py-5 '>
              <h3>RNCP 6 DÉVELOPPEUR WEB ET MOBILE</h3>
              <p>2023<br/>
              ...
              <h3>LICENCE PRO INFORMATIQUE MULTIMÉDIA (IMASH)</h3>
              <p>2009 - 2008<br/>Université Nice Sophia Antipolis</p>
